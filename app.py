...
"""
            ...
            def ask_gemini_with_retry(prompt_text):
                # Use stable, lightweight models first. Google currently lists
                # Gemini 2.5 Flash-Lite as the fastest/budget-friendly option
                # for high-frequency simple requests, followed by 2.5 Flash.
                models = [
